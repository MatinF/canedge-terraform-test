...
gcloud services enable iam.googleapis.com cloudfunctions.googleapis.com cloudbuild.googleapis.com --quiet
echo "✓ Required APIs enabled (IAM, Cloud Functions, Cloud Build)."
