...
show_help() {
  ...
  echo "  -d, --dataset DATASET_ID    BigQuery dataset ID (default: lakedataset1)"
  echo "  -y, --auto-approve          Skip approval prompt"
  echo "  -h, --help                  Show this help message"
  echo
  echo "Example:"
  echo "  ./deploy_bigquery.sh --project my-project-123 --bucket canedge-test-bucket-gcp --id my-analytics"
}

# Default values
UNIQUE_ID="canedge-demo"
AUTO_APPROVE="-auto-approve" # Auto-approve by default
DATASET_ID="lakedataset1"    # Default dataset ID
